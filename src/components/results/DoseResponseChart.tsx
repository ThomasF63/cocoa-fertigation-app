      ...
      <ResponsiveContainer width="100%" height="100%">
        <ComposedChart data={rows} margin={{ top: 10, right: 20, left: 10, bottom: 20 }}>
          ...
          <XAxis
            ...
            domain={[0, 400]}
            ticks={[56, 226, 340]}
            label={{ value: "N dose (kg N ha\u207B\u00B9 yr\u207B\u00B9)", position: "bottom", offset: 8, fontFamily: CHART_FONT_MONO, fontSize: 11, fill: "var(--text-secondary)" }}
          ...
          />
          <Tooltip
            contentStyle={{ fontFamily: CHART_FONT_MONO, fontSize: 12, borderRadius: 8, border: "1px solid var(--panel-border)" }}
          />
